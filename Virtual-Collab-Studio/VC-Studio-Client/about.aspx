<%@ Page Title="about" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="VC_Studio_Client.about" %>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body w-100">
                <div
                    class="title-bar mt-3 position-relative d-flex align-items-center justify-content-center rounded w-100">
                    <div class="background-overlay"></div>
                    <div class="grid-overlay"></div>
                    <div class="content text-center">
                        <h1 class="main-heading text-start">Code, collaborate, and innovate together,<br>
                            let's shape the future of technology.
                        </h1>
                        <p class="sub-heading text-start">
            ...
            <div class="card-body text-white mx-4" style="background-color: #000000;">
                <div class="d-flex align-items-center">
                    <span class="mb-0 me-2 p-3 fw-bolder" style="font-size: 24px;">15+ Language
                        Supports</span>
                    <span class="mb-0 fw-bolder" style="color: #9B9C9E; font-size: 14px;">Build,
                        collaborate, and
                        innovate across multiple programming languages. Craft mobile
                        apps, web platforms, or system-level solutions with ease in our versatile
                        environment.</span>
                </div>
                <div class="tech-slideshow">
                    <div class="marquee-img">
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/javascript.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">JavaScript</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/c-sharp.svg" class="ms-3" height="40rem" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">C#</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/java-4 1.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">JAVA</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/c 1.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">C++</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                ...
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">Python</span>
                            </div>
                        </div>
                ...
                <div class="tech-slideshow-2">
                    <div class="marquee-img-2">

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/ruby 1.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">Ruby</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/swift-15 1.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">Swift</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/kotlin-1 1.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">Kotlin</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/php.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">PHP</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center align-items-center">
                            <div class="card text-center " style="border: 1px solid #A1AEBF; border-radius: 10px; border-width: 2px; height: 55px; width: 245px; margin-right: 10px; text-align: center; display: flex; flex-direction: row; align-items: center;">
                                <img src="assets/icons/haskell 1.svg" class="ms-3" alt="">
                                <span class="text-center ms-2"
                                    style="font-size: 24px; color: #FFFFFF;">HasKell</span>
                            </div>
                        </div>
            ...
            <div class="container mt-5">
                <center>
                    <h1 class="text-white mb-4">We Offer</h1>
                </center>
                <div class="container w-50 text-center mb-3">
                    <span style="color: #9B9C9E;">Empowering developers, students, and programmers to collaborate in real time,
                        code
                        in any language, and share knowledge
                        effortlessly—all on one unified platform.</span>
                </div>
                <div class="container">
                    <div class="row justify-content-center mb-4 p-4">

                        <!-- First Row of Cards -->
                        <div class="row row-cols-1 d-flex justify-content-center row-cols-md-4 g-4">
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card text-start tilt card-height"
                                    style="border: 1px solid #A1AEBF; border-radius: 4px;">
                                    <img src="assets/icons/Collabrative.svg" class="my-3 ms-3"
                                        style="width: 50px; height: 50px;" alt="">
                                    <h5 class="text-white mb-3 ms-4">Collaborative</h5>
                                    <p class="px-4" style="color: #9B9C9E;">
                                        Code together instantly with
                                        unique workspace IDs and live
                                        updates.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card text-start tilt card-height"
                                    style="border: 1px solid #A1AEBF; border-radius: 4px;">
                                    <img src="assets/icons/Open source.svg" class="my-3 ms-3"
                                        style="width: 50px; height: 50px;" alt="">
                                    <h5 class="text-white mb-3 ms-4">Open Source</h5>
                                    <p class="px-4" style="color: #9B9C9E;">
                                        Contribute and innovate with
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card text-start tilt card-height"
                                    style="border: 1px solid #A1AEBF; border-radius: 4px;">
                                    <img src="assets/icons/Multi.svg" class="my-3 ms-3"
                                        style="width: 50px; height: 50px;" alt="">
                                    <h5 class="text-white mb-3 ms-4">Multi-Language</h5>
                                    <p class="px-4" style="color: #9B9C9E;">
                                        Work in 15+ programming
                                        languages, all in one platform.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            class="row row-cols-1 d-flex justify-content-center row-cols-md-4 g-4 mt-4">
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card text-start tilt card-height"
                                    style="border: 1px solid #A1AEBF; border-radius: 4px;">
                                    <img src="assets/icons/code.svg" class="my-3 ms-3"
                                        style="width: 50px; height: 50px;" alt="">
                                    <h5 class="text-white mb-3 ms-4">Code Snippe</h5>
                                    <p class="px-4" style="color: #9B9C9E;">
                                        Share and copy reusable code
                                        snippets instantly.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card text-start tilt card-height"
                                    style="border: 1px solid #A1AEBF; border-radius: 4px;">
                                    <img src="assets/icons/posts.svg" class="my-3 ms-3"
                                        style="width: 50px; height: 50px;" alt="">
                                    <h5 class="text-white mb-3 ms-4">Posts</h5>
                                    <p class="px-4" style="color: #9B9C9E;">
                                        Share and explore code
                                        snippets with detailed descriptions
                                        and ratings.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 mb-4">
                                <div class="card text-start tilt card-height"
                                    style="border: 1px solid #A1AEBF; border-radius: 4px;">
                                    <img src="assets/icons/instant.svg" class="my-3 ms-3"
                                        style="width: 50px; height: 50px;" alt="">
                                    <h5 class="text-white mb-3 ms-4">Instant Interaction</h5>
                                    <p class="px-4" style="color: #9B9C9E;">
                                        Communicate seamlessly with
                                        real-time Interactive Compiler
                                        with smooth teamwork.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                    <div class="flex-shrink-0" style="width: 570px;">
                        <svg width="642" height="361" viewBox="0 0 642 361" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M263.369 104.806C259.781 104.806 259.775 99.2305 263.369 99.2305C266.956 99.2305 266.962 104.806 263.369 104.806Z" fill="url(#paint26_linear_49_8791)" />
                            <defs>
                                <linearGradient id="paint0_linear_49_8791" x1="414.577" y1="108.185" x2="438.149" y2="154.386" gradientUnits="userSpaceOnUse">
                                    ...
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                ...
                                <linearGradient id="paint2_linear_49_8791" x1="418.87" y1="117.139" x2="420.913" y2="125.297" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" stop-opacity="0.866667" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                ...
                                <linearGradient id="paint14_linear_49_8791" x1="221.095" y1="61.0553" x2="235.587" y2="102.956" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint15_linear_49_8791" x1="229.248" y1="61.2955" x2="240.854" y2="74.5278" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint16_linear_49_8791" x1="207.158" y1="64.6244" x2="217.451" y2="68.167" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint17_linear_49_8791" x1="255.771" y1="78.622" x2="256.234" y2="81.9013" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint18_linear_49_8791" x1="273.072" y1="97.2187" x2="285.486" y2="103.958" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint19_linear_49_8791" x1="218.091" y1="99.2372" x2="248.018" y2="145.072" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint20_linear_49_8791" x1="257.405" y1="93.8814" x2="258.455" y2="97.8051" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                                <linearGradient id="paint21_linear_49_8791" x1="219.162" y1="96.2846" x2="228.924" y2="103.136" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#4D62E5" />
                                    <stop offset="0.0001" stop-color="#87DDEE" />
                                    <stop offset="0.490049" stop-color="#B6F09C" />
                                </linearGradient>
                    ...
                    <div class="text-white">
                        <h2 class="mb-3 fs-3">Why Choose Us</h2>
                        <p class="text-secondary mb-0">
                            We’re not just a platform—we’re a community. Collaborate, innovate, and grow with advanced tools and a network of like-minded developers. Together, we build the future of technology.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body mx-4 mt-3" style="background-color: #000000;">
                <div class="p-4 mt-2">
                    <span style="color: white; font-size: 36px;">Our Team</span>
                </div>
                <div class="container mt-4">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 d-flex justify-content-center g-4">
                        <div class="col">
                            <div class="card card-height text-start tilt-effect"
                                style="border: 1px solid #A1AEBF; border-width: 2px; background-color: #0F0F0F; border-radius: 4px;">
                                <div class="d-flex justify-content-start ms-4 align-items-center mt-3">
                                    <div class="d-flex justify-content-center align-items-center bg-primary text-center text-white rounded-circle me-2"
                                        style="width: 40px; height: 40px;">
                                        Y
                                    </div>
                                    <div class="ms-3 text-center">
                                        <span class="text-white d-block">Yash Lalani</span>
                                        <small class="text-muted text-start d-block">Dev</small>
                                    </div>
                                </div>
                                <p class="text-white px-4 mt-5">
                                    Yash developed a seamless and visually appealing UI. His design ensures smooth user interactions and an intuitive
                                    experience.
                                </p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card card-height text-start tilt-effect"
                                ...
                                <div class="d-flex justify-content-start ms-4 align-items-center mt-3">
                                    ...
                                    <div class="ms-3 text-center">
                                        <span class="text-white d-block">Jigar Kalariya</span>
                                        <small class="text-muted text-start d-block">Dev</small>
                                    </div>
                                </div>
                                <p class="text-white px-4 mt-5">
                        ...
                        <div class="col">
                            <div class="card card-height text-start tilt-effect"
                                ...
                                <div class="d-flex justify-content-start ms-4 align-items-center mt-3">
                                    ...
                                    <div class="ms-3 text-center">
                                        <span class="text-white d-block">Sarthak Dhaduk</span>
                                        <small class="text-muted text-start d-block">Dev</small>
                                    </div>
                                </div>
                                <p class="text-white px-4 mt-5">
                                    Sarthak built the backend framework, ensuring data security and system reliability. His work supports the app's overall
                                    performance.
                                </p>
                            </div>
                        </div>
